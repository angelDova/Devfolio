    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Angel</span>
          <span className="seq"> Cordova</span>
        </h1>
        <p>
          <span
            ref={typedEl}
        ...
        <div className="seq pt-4">
          <Button
            ...
            href="https://drive.google.com/drive/folders/1zfjP9ED6qah9_Q7prvpHNKJPeqx5S5fK?usp=share_link"
          >
            Resume
          </Button>
